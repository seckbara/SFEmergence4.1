 ...
 */
final class Version20181118110201 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adherent (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, date_naissance DATETIME NOT NULL, sexe VARCHAR(15) NOT NULL, telephone VARCHAR(50) NOT NULL, adresse VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, certificat VARCHAR(3) NOT NULL, nume_secu VARCHAR(255) NOT NULL, document VARCHAR(255) NOT NULL, commentaire LONGTEXT NOT NULL, photo VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, user VARCHAR(255) NOT NULL, situation VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
